...
// email verification removed; no email sending
...
async function login(username, password) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            // email verification removed: no verified check
...
// removed verification endpoints
...
app.post('/account/register', (req, res) => {
    ...
    insertToUsers({
        ...
        .then(() => {
            // email verification removed: account active immediately
            res.json({
                success: true,
            })
        })
